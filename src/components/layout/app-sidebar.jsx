  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-64 z-50">
      ...
      <Sidebar
        ...
        collapsible="none"
        side="left"
        className="border-r-0 bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl h-full"
      >
        <SidebarHeader className="flex-shrink-0 py-6">
